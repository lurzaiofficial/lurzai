...
const metrics = [
  { value: 4, suffix: '', prefix: '', label: 'Markets in one workspace' },
  { value: 100, suffix: '%', prefix: '', label: 'Confidence scored on every call' },
  { value: 12, suffix: '+', prefix: '', label: 'Technical indicators scored' },
  { value: 24, suffix: '/7', prefix: '', label: 'Crypto coverage while you sleep' },
];
