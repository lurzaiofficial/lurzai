...
const features = [
  {
    ...
    description:
      'Get clear verdicts backed by technical indicators and AI interpretation — buy, sell, or stand aside with confidence scores.',
    visual: 'ai',
  },
  {
    number: '02',
    ...
    description:
      'Analyse crypto, stocks, forex and commodities from one workspace. Search instruments, favourites, and switch timeframes instantly.',
    visual: 'deploy',
  },
  {
    number: '03',
    title: 'Live charts & tracking',
    description:
      'Watch price action update in real time, follow active signals, and review history so you can learn what setups actually worked.',
    visual: 'collab',
  },
  {
    number: '04',
    ...
    description:
      'LURZ sharpens the setup — you size, time, and execute. Built for discretionary traders who want clarity, not autopilot.',
    visual: 'security',
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const x = Number((100 + Math.cos(angle) * radius).toFixed(6));
        const y = Number((80 + Math.sin(angle) * radius).toFixed(6));
        return (
          <g key={i}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="mb-16 lg:mb-24">
          ...
          >
            Built for traders.
            <br />
            <span className="text-muted-foreground">Not for bots.</span>
          </h2>
        </div>
        <div>
